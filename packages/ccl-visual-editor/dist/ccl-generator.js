...
export class CCLGenerator {
    static generateFromContract(contract) {
        const errors = [];
        const warnings = [];
        try {
...
class CCLBuilder {
    ...
    addMainFunction(nodes, connections) {
