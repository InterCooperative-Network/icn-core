...
pub enum ReputationEvent {
    ...
    ReputationUpdated { did: Did, old_score: u32, new_score: u32 },
    ...
    ReputationCalculated { did: Did, score: u32, factors: HashMap<String, f64> },
}
...
pub trait ReputationProvider: Send + Sync {
    ...
    async fn subscribe_to_events(&self) -> Result<tokio::sync::mpsc::Receiver<ReputationEvent>, CoreTraitsError>;
    
    /// Calculate trust path between two DIDs
    async fn calculate_trust_path(&self, from: &Did, to: &Did) -> Result<Option<Vec<Did>>, CoreTraitsError>;
}
