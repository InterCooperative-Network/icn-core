...
pub enum CclError {
    ...
    UndefinedSymbol { symbol: String, line: usize, column: usize },
    ...
    FunctionSignatureMismatch { function: String, expected_params: usize, actual_params: usize },
    ...
    ArrayIndexOutOfBounds { index: i64, length: usize, line: usize },
...
impl CclError {
    ...
    pub fn type_error_with_context(expected: &str, found: &str, line: usize, context: &str) -> Self {
    ...
    pub fn suggestions(&self) -> Vec<String> {
        match self {
            ...
            CclError::TypeMismatch { expected, found, .. } => {
                vec![
