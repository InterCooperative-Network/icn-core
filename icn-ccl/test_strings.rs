// test_strings.rs
// Test string operations to identify what's missing
...
fn main() {
    ...
    match compile_ccl_source_to_wasm(source4) {
        Ok((wasm, _metadata)) => {
            println!("✅ String formatting compiled successfully!");
            println!("WASM size: {} bytes", wasm.len());
        }
        Err(e) => {
    ...
    let source5 = r#"
        contract TestStringComparison {
            ...
            fn test_string_comparison() -> Bool {
                let str1 = "hello";
                let str2 = "hello";
                return str1 == str2;
            }
    ...
    let source6 = r#"
        contract TestStringIndexing {
            ...
            fn test_string_indexing() -> String {
                let text = "Hello";
                return text[0];
            }
        }
    ...
    match compile_ccl_source_to_wasm(source6) {
        Ok((wasm, _metadata)) => {
            println!("✅ String indexing compiled successfully!");
            println!("WASM size: {} bytes", wasm.len());
        }
        Err(e) => {
